...
const routes: Routes = [
  ...
  { path: 'blog', component: BlogComponent, data: { hideHeader: true, hideFooter: false } },
  { path: 'politica-privacidade', component: PoliticaPrivacidadeComponent, data: { hideHeader: true, hideFooter: false } },
  { path: 'termos-uso', component: TermosUsoComponent, data: { hideHeader: true, hideFooter: true } },
  { path: 'quem-somos', component: QuemSomosComponent, data: { hideHeader: true, hideFooter: false } },
  ...
  { path: 'blog/:id', component: BlogComponent, data: { hideHeader: true, hideFooter: false } },
